...
const ProjectModalSimple = ({ project, isOpen, onClose }) => {
            ...
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className={`relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl border max-w-6xl w-full max-h-[95vh] overflow-hidden shadow-xl ${glowEffect ? 'border-cyan-400 shadow-cyan-400/30' : 'border-cyan-500/30'}`}
                        onClick={(e) => e.stopPropagation()}
                    >
                        {/* Simple border effect */}
                        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 blur-sm"></div>

                        {/* Header with project icon and title */}
                        <div className="relative z-10 bg-gradient-to-r from-slate-900/95 to-slate-800/95 border-b border-cyan-500/30 p-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="relative w-16 h-16 rounded-xl bg-gradient-to-br from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 flex items-center justify-center">
                                        {project.icon ? (
                                            <img
                                                src={project.icon}
                                                alt={project.title}
                        ...
                        {/* Navigation tabs */}
                        <div className="relative z-10 bg-slate-900/50 border-b border-cyan-500/20 px-6 py-4">
                        ...
                        <div className="relative z-10 bg-gradient-to-r from-slate-900/95 to-slate-800/95 border-t border-cyan-500/30 p-6">
                            <div className="flex flex-wrap gap-3">
                                {project.githubLink && (
                                    <motion.a
...
export default ProjectModalSimple;
